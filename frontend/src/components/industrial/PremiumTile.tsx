...
const ACCENT_STYLE: Record<TileAccent, {
  ...
  primary: {
    borderIdle: 'border-primary-light/25',
    borderHover: '',
    bg: 'linear-gradient(135deg, rgba(74,156,216,0.10), rgba(15,24,37,0.7))',
    shadow: '0 4px 20px rgba(74,156,216,0.10)',
    iconColor: 'text-primary-light',
    iconBg: 'rgba(74,156,216,0.12)',
    valueColor: 'text-primary-light',
    dotColor: 'text-primary-light',
  },
  accent: {
    borderIdle: 'border-ok/25',
    borderHover: '',
    bg: 'linear-gradient(135deg, rgba(0,229,160,0.08), rgba(15,24,37,0.7))',
    shadow: '0 4px 20px rgba(0,229,160,0.08)',
    iconColor: 'text-ok',
  ...
  warn: {
    borderIdle: 'border-warn/30',
    borderHover: '',
    bg: 'linear-gradient(135deg, rgba(255,184,0,0.08), rgba(15,24,37,0.7))',
    iconColor: 'text-warn',
  ...
  danger: {
    borderIdle: 'border-danger/40',
    borderHover: '',
    bg: 'linear-gradient(135deg, rgba(255,71,87,0.08), rgba(15,24,37,0.7))',
