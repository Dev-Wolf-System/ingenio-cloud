...
export interface LabRow { proceso_codigo: string; fecha_industrial: string; hora_lectura: string | null; kilos: number | null; brix_manual: number | null; brix_automatico: number | null; pol_manual: number | null; pol_automatico: number | null; pureza: number | null; ph_manual: number | null; temperatura_manual: number | null }
